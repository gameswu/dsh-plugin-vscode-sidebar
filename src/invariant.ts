/**
 * Package-owned invariant companion for `dsh-plugin-vscode-sidebar`.
 * @module dsh-plugin-vscode-sidebar/invariant
 */

/* jscpd:ignore-start */
import type { Context } from './context-types.ts'

const PACKAGE_NAME = 'dsh-plugin-vscode-sidebar'

/** Cordis companion plugin name. */
export const name = 'dsh-plugin-vscode-sidebar-invariant'
