 ...
 * previewers through the same {@link VscodeSidebarService} external plugins
...
import type { VscodeSidebarService } from '../service.ts'
 ...
 * (EditorHost reads `ctx.vscodeSidebar` for file-viewer matching).
 */
export function registerBuiltins(ctx: Context, service: VscodeSidebarService): () => void {
