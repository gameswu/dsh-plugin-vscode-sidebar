  ...
  useEffect(() => {
    ...
    const connect = (): void => {
      ...
      socket.onclose = (event) => {
        ...
        if (failures >= FAILURE_LIMIT) {
          ...
          console.error('[dsh-plugin-vscode-sidebar] terminal connection failed:', event.code, event.reason, url)
    ...
    const cancelOpen = openWhenSized(host, () => {
      try {
        ...
        console.error('[dsh-plugin-vscode-sidebar] xterm open failed:', error)
      }
    })
