...
export function parsePrefs(value: unknown): SidebarPrefs {
  ...
  return {
    ...
    autoOpenJobStream: typeof record.autoOpenJobStream === 'boolean'
      ? record.autoOpenJobStream
      : SIDEBAR_PREFS_DEFAULTS.autoOpenJobStream,
    autoSaveOnClose: typeof record.autoSaveOnClose === 'boolean'
      ? record.autoSaveOnClose
      : SIDEBAR_PREFS_DEFAULTS.autoSaveOnClose,
