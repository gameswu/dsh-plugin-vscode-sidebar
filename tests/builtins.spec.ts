...
import { createVscodeSidebarService } from '../src/client/service.ts'
import { createSidebarStore } from '../src/client/state.ts'
import { allLeaves } from '../src/client/state.ts'
import { registerBuiltins } from '../src/client/builtins/index.ts'

function setup(): { service: ReturnType<typeof createVscodeSidebarService>; store: ReturnType<typeof createSidebarStore>; dispose: () => void } {
...
describe('built-in tab registrations', () => {
  ...
  it('the subagent tab declares its auto-open related settings', () => {
    ...
    expect(toggles.map(t => t.key)).toEqual(['autoOpenSubagent', 'autoOpenJobs', 'autoOpenJobStream'])
  })
